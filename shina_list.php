                                    ...
                                    <div class="nav-filtr-in clearfix">
                                        <div class="nav-filrr-body">
                                            <div class="cheks-gor-item">
                                                <div class="cheks-bloks">
                                                    <input type="checkbox">
                                                    <label class="icon-winter" >
                                                        <span>Зимние</span>
                                                    </label>
                                                </div>
                                                <div class="cheks-bloks">
                                                    <input type="checkbox">
                                                    <label class="icon-summer" >
                                                        <span>Летние</span>
                                                    </label>
                                                </div>
                                                <div class="cheks-bloks">
                    ...
                    <div class="row">
                        <div class="choice">
                            ...
                            <div class="col-xs-10 item_block">
                                <!-- item -->
                                <div class="item">
                                    <div class="ch_block_img">
                                        <div class="ch_img">
                                            <img src="/img/bfgoodrich-all-terrain.jpg">
                                            <label class="ch_search"></label>
                                        </div>
                                    </div>
                                    <div class="ch_sezon_block">
                                        <label class="icon-winter_ch"> </label>
                                        <label class="icon-summer_ch"></label>
                                        <label class="icon-spikes_ch"></label>
                                        <label class="icon-flat_ch"></label>
                                    </div>
                                    <div class="ch_block_desc">
                                        <div class="text_ch_tit"><a href="" >Kumho WI31 Kumho WI31Kumho WI3</a></div>
                                        ...
                                        <div class="ch_block_brand">
                                            <div class="ch_brand"><img src="/img/brands_shine/dunlop.jpg"></div>
                                        </div>
                                    </div>
                                    <!--<div class="ch_block_brand">
                                        <div class="ch_brand"><img src="/img/brands_shine/dunlop.jpg"></div>
                                    ...
                                    -->
                                    <div class="ch_block_price">
                                        <div class="ch_price"><span>2&nbsp;080</span>  РУБ.</div>
                                        <div>В наличии , 16 шт.</div>
                                        <div class="button1 btn_ch">
                                            Купить
                                        </div>
                                    </div>
                                    <div class="ch_block_sesshina">
